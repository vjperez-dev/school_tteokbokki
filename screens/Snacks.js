...
const LIST = [
  {
    id: '1',
    title: 'Roasted Seaweeds',
    price: 'Php 25.00',
    image: require('../img/snacks/1.png')
  },
  {
    id: '2',
    title: 'Samyang Sausage',
    price: 'Php 25.00',
    image: require('../img/snacks/2.png')
  },
  {
    id: '3',
    title: 'Corndog',
    price: 'Php 30.00',
    image: require('../img/snacks/3.png')
  },
  {
    id: '4',
    title: 'Lotte Chocopie',
    price: 'Php 27.00',
    image: require('../img/snacks/4.png')
  },
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.title}>
        <Text style={{ fontSize: 32, fontWeight: 'bold', color: 'black' }}>Snacks</Text>
      </View>
      <View style={{
        flexDirection: 'row',
