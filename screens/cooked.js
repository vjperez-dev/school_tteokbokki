...
import { View, FlatList, StyleSheet, Text, TouchableOpacity, StatusBar, ScrollView, Dimensions, Image, TouchableHighlight } from 'react-native';
...
const LIST = [
  {
    ...
    price: 'Php 200.00',
    image: require('../img/cooked/1.png')
  },
  {
    id: '2',
    title: 'Kimchi Rice w/ egg',
    price: 'Php 150.00',
    image: require('../img/cooked/2.png')
  },
  {
    id: '3',
    title: 'Fish Cake Soup',
    price: 'Php 150.00',
    image: require('../img/cooked/3.png')
  },
  {
    id: '4',
    title: 'Gimbap',
    price: 'Php 200.00',
    image: require('../img/cooked/4.png')
  },
  {
    id: '5',
    title: 'Tteokbokki',
    price: 'Php 150.00',
    image: require('../img/cooked/5.png')
  },
  {
    id: '6',
    title: 'Cheesy Tteokbokki',
    price: 'Php 180.00',
    image: require('../img/cooked/6.png')
  },
];
...
const Products = ({ navigation }) => {
  ...
  const Card = ({ LIST }) => {
    return (
      <TouchableHighlight underlayColor='#ffffff' activeOpacity={0.9} onPress={() => navigation.navigate('FrozenFood')}>
    ...
    <View style={{ flex: 1 }}>
      ...
      <View style={styles.container}>
        <View style={styles.title}>
          <Text style={{ fontSize: 32, fontWeight: 'bold', color: 'black' }}>Cooked Foods</Text>
        </View>
